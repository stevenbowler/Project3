                ...
                <Collapse isOpen={this.props.isOpenNavbar} navbar>
                    <Nav className="ml-auto text-light" navbar>
                        ...
                        <ButtonGroup block="true" size="lg">
                            {/* <Button className="authentication-buttons mx-2 pt-3 hover-underline" color="outline-light" hidden={this.props.loggedIn === "true" ? true : false} float="left" display="inline" onClick={this.register}>Register</Button> */}
