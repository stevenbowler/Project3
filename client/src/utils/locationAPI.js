...
export default {
    ...
    findZipCode: function (dispatch) {
        var urlFindLatLng = "https://www.googleapis.com/geolocation/v1/geolocate?key=AIzaSyDOM8_XwRnIiMs5GxUXMJy15zBz_3UwkC4";
        axios
            .post(urlFindLatLng)
            .then(response => {
                ...
                var urlFindZip = `https://maps.googleapis.com/maps/api/geocode/json?latlng=${latitude},${longitude}&key=AIzaSyDOM8_XwRnIiMs5GxUXMJy15zBz_3UwkC4`
                axios
                    .post(urlFindZip)
                    .then(response => {
